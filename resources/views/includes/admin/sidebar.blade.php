...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        ...
        <div class="sidebar-brand-text mx-3">Grow Up</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('type-of-immunization.index') }}">
            <i class="fas fa-fw fa-image"></i>
            <span>Jenis Imunisasi</span></a>
    </li>
    {{-- <li class="nav-item">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="">Parent</a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMerk"
            aria-expanded="true" aria-controls="collapseMerl">
